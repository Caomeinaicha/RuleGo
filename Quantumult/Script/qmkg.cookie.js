const $shan = init();
$shan.url = "shan_qmkg_url"
$shan.headers = "shan_qmkg_headers";
$shan.body = "shan_qmkg_body";
...
try {
    ...
    $shan.write(url, $shan.url);
    const headers = JSON.stringify($request.headers);
    $shan.write(headers, $shan.headers);
    ...
    $shan.write(JSON.stringify(body), $shan.body);
    $shan.notify("全民K歌", "Cookie", "Cookie获取成功")
} catch (error) {
    console.log(error)
    $shan.notify("全民K歌", "Cookie获取失败", "请查看日志")
}
